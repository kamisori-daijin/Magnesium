...
class ANE3DRenderer64(nn.Module):
    ...
    def forward(self, 
        ...
        edges0 = compute_edges(A0, B0, C0) # p0-p1 Edge
        edges1 = compute_edges(A1, B1, C1) # p1-p2 Edge
        edges2 = compute_edges(A2, B2, C2) # p2-p0 Edge
        ...
        pixel_inv_z = (p0_z_space + p1_z_space + p2_z_space) * mask # [1, 64, 256, 256]
